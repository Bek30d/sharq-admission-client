...
const PaymentDetailsCard = () => {
    return (
        <div className='flex flex-col gap-4 p-4 shadow-md bg-white rounded md:w-[440px] w-full'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex justify-between pb-4 border-b border-[#EAEEF2]'>
                            ...
                            <div className='flex flex-col gap-2 items-end'>
                                <Badge className='w-fit !bg-green-400 px-1.5 py-1 rounded-md'>To’langan</Badge>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex flex-col gap-2'>
                    <Badge variant="destructive" className='w-fit px-1.5 py-1 rounded-md'>To’lanmagan</Badge>
                    <p className='text-sm text-[#18324D]'>22.05.24 14:15</p>
                </div>
            </div>
            <div className='flex justify-between'>
            ...
            <div className='flex justify-between gap-4'>
                <Button className='flex-1 group hover:!bg-[#18324D] duration-300 flex items-center gap-1.5 text-[#424A53]' variant={'outline'}>
